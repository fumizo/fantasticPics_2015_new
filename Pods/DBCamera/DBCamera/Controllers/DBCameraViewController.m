...
- (void) captureImageDidFinish:(UIImage *)image withMetadata:(NSDictionary *)metadata
{
    ...
    if ( !self.useCameraSegue ) {
        ...
        DBCameraSegueViewController *segue = [[DBCameraSegueViewController alloc] initWithImage:image thumb:[UIImage returnImage:image withSize:(CGSize){ newW, newH }] boolsecond:false];
